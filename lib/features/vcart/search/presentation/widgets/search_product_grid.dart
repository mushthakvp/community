...
class SearchProductGrid extends StatelessWidget {
  ...
  // Helper method to convert SearchProduct to Product entity for ProductCard
  dynamic _convertToProductEntity(SearchProduct product) {
    return _SearchProductAdapter(product);
  }
}

// Adapter class to make SearchProduct compatible with ProductCard
class _SearchProductAdapter {
  final SearchProduct _product;

  _SearchProductAdapter(this._product);
